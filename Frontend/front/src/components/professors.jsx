    ...
    return(
        <div>
            <div className="div-principal">
                <button className="button-menu" onClick={()=>showWhat(1)}>Registrar Profesor</button>
                <button className="button-menu" onClick={()=>showWhat(2)}>Modificar Datos de Profesor</button>
                <button className="button-menu" onClick={()=>showWhat(3)}>Eliminar Profesor</button>
